...
public class JSONParser {
    ...
    public static String getStream2(String url) {
        InputStream is = null;
        try {
    ...
    public static void postStream(String url, String data) {
        InputStream is = null;
        try {
            URL u = new URL(url);
            HttpURLConnection conn = (HttpURLConnection) u.openConnection();
...
//        return readStream(is);
    ...
    public static JSONArray getJSONArrayFromUrl2(String url) {
        JSONArray jArray = null;
        Log.i("JSONParser",url);
        try {
            jArray = new JSONArray(getStream2(url));
        } catch (JSONException e) {
            Log.e("Exception", StackTrace.trace(e));
        }
        return jArray;
