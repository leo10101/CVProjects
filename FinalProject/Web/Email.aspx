    ...
    <form id="form1" runat="server">
        ...
        <table align="center" class="auto-style12">
            ...
            <tr>
                ...
                <td class="auto-style24"><asp:TextBox ID="Txt_password" runat="server"  Width="99%" TextMode="Password" ValidationGroup="a"></asp:TextBox>               
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Txt_password" ErrorMessage="password can not be empty" ForeColor="Red" ValidationGroup="a"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="auto-style33">receiver1</td>
                <td class="auto-style34">
                    <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource1" DataTextField="Email" DataValueField="Email"  AppendDataBoundItems="True">
            ...
            <tr>
                ...
                <td class="auto-style15">
                    <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource1" DataTextField="Email" DataValueField="Email"  AppendDataBoundItems="True" style="height: 19px">
                         <asp:ListItem Value="0">Please Select</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="auto-style14">
                    <asp:Button ID="Send" OnClick="send_Click" runat="server" Text="Send" Width="70px" CssClass="auto-style7" Height="25px" ValidationGroup="a"/>
                </td>
            </tr>
            <tr>
