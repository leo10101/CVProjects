...
<body style="height: 377px">
    <form id="form1" runat="server">
        <div style="height: 387px; width: 819px;">
             <div>
            <br />
            <br />
            ...
            <br />
             <asp:Label ID="Label3" runat="server" Text="New Password"></asp:Label>
                 ...
                 &nbsp
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbx_Password" ErrorMessage="Please enter new password" ForeColor="Red" ValidationGroup="a"></asp:RequiredFieldValidator>
            <br />
                 <asp:Label ID="Label4" runat="server" Text="Confirm New Password "></asp:Label>
                 <asp:TextBox ID="tbx_Confirm" runat="server" TextMode="Password"></asp:TextBox>
            <br />
                 <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="tbx_Confirm" ControlToValidate="tbx_Password" ErrorMessage="The passwords entered are inconsistent" ForeColor="Red" ValidationGroup="a"></asp:CompareValidator>
