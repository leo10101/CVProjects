<%@ Page Language="C#" MasterPageFile="~/StoreManager.Master" AutoEventWireup="true" CodeBehind="ManagerHomePage.aspx.cs" Inherits="AD.Store.ManagerHomePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
        ...
        <asp:Label runat="server" Text="lab_employeeid" ID="lab_employeeid"></asp:Label>
        <br/>
