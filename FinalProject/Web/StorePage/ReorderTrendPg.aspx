<%@ Page Language="C#" MasterPageFile="~/StoreSupervisor.Master" AutoEventWireup="true" CodeBehind="ReorderTrendPg.aspx.cs" Inherits="AD.StorePage.ReorderTrendPg" %>
<%--YANGXU--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div id="page" class="container container-fluid" style="text-align: center;">
        <h2 style="color: #fbc531; font-weight: bold">ReOrder Trend Report</h2>
        <br />
        <br />
