<%@ Page Language="C#" MasterPageFile="~/StoreSupervisor.Master" AutoEventWireup="true" CodeBehind="SupervisorAdjustmentVoucherDetails.aspx.cs" Inherits="AD.Store.SupervisorAdjustmentVoucherDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
        ...
        <asp:Button ID="bt_back" class="btnYellow" runat="server" Text="Go Back" OnClick="lab_approve_Click" />
        <asp:Button ID="btn_Notification" class="btnYellow" runat="server" OnClick="btn_Notification_Click" Text="Send Notification" />
        <p>
            &nbsp;</p>
